...
{{--            dump($order)--}}
{{--            @endphp--}}
            <div class="row align-content-between" style="margin-left: 1px;">
                <div class="mt-4">
                ...
                <div class="w-75 mt-4">
                    ...
                    <table class="table table-bordered table-light" style="min-height: 130px;">
                        <thead>
                        <tr class="">
        ...
        <div class="container-fluid bg-light mt-lg-4" style="min-height: 250px;">
