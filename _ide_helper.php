 ...
 */
     ...
     */
        ...
        public static function getName()
        {
                    ...
                    /**
         * Get the name of the cookie used to stores the "recaller".
         *
         * @return string
         * @static
         */
        ...
        public static function setDispatcher($events)
        {
                    ...
                    /**
         * Get the session stores used by the guard.
         *
     ...
     */
        class Cache {
                    /**
         * Get a cache stores instance by name, wrapped in a repository.
         *
         * @param string|null $name
         ...
         *
         * @return bool
         * @param string $key The key of the item to stores.
         * @param mixed $value The value of the item to stores, must be serializable.
        ...
        public static function forever($key, $value)
        {
                    ...
                    /**
         * Get an item from the cache, or execute the given Closure and stores the result.
         *
         * @param string $key
        ...
        public static function remember($key, $ttl, $callback)
        {
                    ...
                    /**
         * Get an item from the cache, or execute the given Closure and stores the result forever.
         *
         * @param string $key
         * @param \Closure $callback
         * @return mixed
        ...
        public static function clear()
        {
                    ...
                    /**
         * Begin executing a new tags operation if the stores supports it.
         *
        ...
        public static function tags($names)
        {
                    ...
                    /**
         * Determine if the current stores supports tags.
         *
         * @return bool
         * @static
         */
        ...
        public static function setDefaultCacheTime($seconds)
        {
                    ...
                    /**
         * Get the cache stores implementation.
         *
     ...
     */
        ...
        public static function shouldBlock()
        {
                    ...
                    /**
         * Get the name of the cache stores / driver that should be used to acquire session locks.
         *
         * @return string|null
         * @static
         */
        ...
        public static function put($key, $value = null)
        {
                    ...
                    /**
         * Get an item from the session, or stores the default value.
         *
         * @param string $key
         * @param \Closure $callback
         * @return mixed
...
')
     ...
     */
        ...
        {            //Method inherited from \DebugBar\DebugBar
                    ...
                    /**
         * Sets the storage backend to use to stores the collected data
         *
        ...
        {            //Method inherited from \DebugBar\DebugBar
                    ...
                    /**
         * Sets whether to only use the session to stores stacked data even
        ...
        {            //Method inherited from \DebugBar\DebugBar
                    ...
                    /**
         * Checks if the session is always used to stores stacked data
